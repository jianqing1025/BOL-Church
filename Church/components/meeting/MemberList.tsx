...
import { MicOff, UserMinus } from 'lucide-react';
...
export const MemberList: React.FC<MemberListProps> = ({ users, isHost, ownUserId, onMute, onRemove }) => {
              ...
              {controllable && (
                <span className="ml-auto flex shrink-0 items-center gap-0.5">
                  <button
                    type="button"
                    onClick={() => onMute?.(u.id)}
                    aria-label={t('meeting.hostMute')}
                    title={t('meeting.hostMute')}

    ...
    <div className="bg-white p-8 sm:p-12 rounded-2xl shadow-lg max-w-4xl mx-auto border border-gray-100">
      ...
      {submitted ? (
          <div className="bg-green-50 text-green-800 p-8 rounded-xl text-center">
              ...
              <p className="text-lg">Your prayer request has been shared with our prayer team. We are standing with you in prayer.</p>
              <button onClick={() => setSubmitted(false)} className="mt-6 text-blue-600 font-semibold hover:underline">Submit another request</button>
          </div>
      ) : (

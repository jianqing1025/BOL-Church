...
export function buildReplyEmail(kind: MailboxKind, parent: ReplyParent, body: string): { subject: string; html: string } {
  ...
  <p style="margin:0 0 12px;">親愛的 ${escapeHtml(name)}：</p>
  <div style="margin:0 0 16px;">${bodyHtml}</div>
  <p style="margin:16px 0 4px;color:#555;">信望愛靈糧堂 Lingling 敬上</p>

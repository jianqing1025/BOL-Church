...
**開啟**的條件是房間的那一張共享畫面有沒有被佔住，而不是房間裡有沒有 Host——一位沒有在分享任何東西的 Host，不應該讓其他所有人都不能分享。Host 仍然可以從佔用者手上接手。

**控制**（播放、暫停、跳轉、關閉）屬於開啟它的那個人，由 Durable Object 認定並蓋章，客戶端自稱一律不採信。

> 初版沿用了聖經同步的「Host，或房間裡沒有 Host 時任何人」，但那條規則對影片是錯的：聖經只有一份進度、誰翻都一樣，而影片佔用的是一個實體資源。2026-09-23 改為以佔用為準。
